...
import sparkplug.config.timereporter
...
class Timer( object ):
    def __init__( self, callback, timers=[] ):
        self._timers = tuple( sparkplug.config.timereporter.registry[t] for t in timers if t in sparkplug.config.timereporter.registry )
